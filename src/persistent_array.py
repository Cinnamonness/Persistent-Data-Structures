class PersistentArray:
    """
    Реализация метода path copying
    """
    ...
    def __init__(self, max_size=None, depth=5, bits_for_level=4):
        ...
        :param max_size: Максимальный размер массива (если
        не указан, используется размер по умолчанию).
    ...
    def _check_index(self, index):
        ...
        :raises IndexError: Если индекс выходит
        за пределы массива.
        """
    ...
    def clone(self):
        """
        Создаёт и возвращает новый массив,
        который является копией текущего.
        :return: Клонированный массив.
        """
        new_array = PersistentArray(self.max_size, self.depth,
                                    self.bits_for_level)
    ...
    def __setitem__(self, index, value):
        ...
        :param index: Индекс, на который нужно вставить 
        или заменить элемент.
        :param value: Новый элемент.
        """
        current_state = self._get_current_state()
        self.history.append(current_state[:index]
                            + [value] + current_state[index + 1:])
