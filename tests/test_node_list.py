...
from node_list import PersistentLinkedListFatNode
...
def test_versioning(fat_node_list):
    ...
    assert fat_node_list.get_version(0) == []
    assert fat_node_list.get_version(1) == [1]
    assert fat_node_list.get_version(2) == [1, 2]
