...
| **до 21.12.2024**  | **Реализация дополнительной функциональности:** <br> - Реализовать более эффективное по памяти представление структур данных <br> - Реализовать универсальный undo-redo механизм для перечисленных структур с поддержкой каскадности (для вложенных структур) <br> - Реализовать поддержку транзакционной памяти (STM) | - Ответственный за улучшение эффективности по памяти: *Полина* <br> - Ответственный за реализацию undo-redo механизма: *Дмитрий* <br> - Ответственный за поддержку транзакционной памяти (STM): *совместно* |
